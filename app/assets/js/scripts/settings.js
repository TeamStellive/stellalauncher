...
const SettingsJavaGuard = require('helios-core/java')
...
async function populateJavaExecDetails(execPath){
    ...
    const details = await SettingsJavaGuard.validateSelectedJvm(
        SettingsJavaGuard.ensureJavaDirIsRoot(execPath),
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/TeamStellive/stellalauncher/releases.atom',
        success: (data) => {
